...
### 배포 정책
- **저장소는 공개되어 있지만, 모든 권리는 매튜에게 있습니다 (All Rights Reserved).**
- *누구나 코드·문서를 볼 수* 있습니다 (학습 목적 환영).
- *재배포·수정·상업적 사용·다른 매체로의 복제*는 매튜의 허락 없이 할 수 없습니다.
- 강의 자료를 본인 작업·블로그·강의에 *재사용*하실 계획이라면 사전에 문의해 주세요.
...
- 2026-05-02: 패키지 골격 생성, 비공개 정책으로 시작.
- 2026-05-02: 동봉 외부 자료를 **Anthropic skill-creator (Apache 2.0)** 로 결정. (Superpowers writing-skills MIT 동봉 계획은 채택하지 않음.)
- 2026-05-02: **공개 저장소(GitHub Public)로 전환**. 라이선스는 *All Rights Reserved* 유지 — 누구나 보고 학습할 수 있지만, 재배포·수정·상업 사용은 사전 허락 필요.
